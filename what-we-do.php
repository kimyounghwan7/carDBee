				...
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							...
							<h2 class="colorlib-heading">Card recommendation</h2>

							<div class="row">
								<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
									<p><a href="choose-a-card.php" class="btn btn-primary btn-learn">Recommend a card!</a></p>
								</div>
							</div>
							<p>We recommend a card for you.</p>
