		...
		<div id="colorlib-main">
			<div class="colorlib-services">
				<div class="colorlib-narrow-content">
					...
					<div class="row">
						<div class="col-md-4">
							<a href="by-franchise.php" class="services-wrap animate-box" data-animate-effect="fadeInRight">
						...
						<div class="col-md-4">
							<a href="by-benefits.php" class="services-wrap animate-box" data-animate-effect="fadeInRight">
